...
::: notes
Zsuzsa:
- put together a interactive web app with dual purpose:
  - demonstrates how easy it is to do it in R (less than 40 lines of code)
  - shows some data that supports my argument 
- comment on general trends: Python more popular than R but as a true data scientist I disregard this
- in some areas python and R are neck and neck
- only search term that shows some promise for Stata is "panel data"
:::
...
- plotting: highlight `ggplot2`, which was also copied in Python
...
::: {.fragment style="text-align: center; margin: 2em 0em 2em 0em;"}
